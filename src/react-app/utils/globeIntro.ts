...
export const GLOBE_INTRO_AUTO_DURATION_MS = 16000
export const GLOBE_INTRO_TILE_LOAD_INTERVAL_MS = 100
export const GLOBE_INTRO_CENTER_PREFETCH_INTERVAL_MS = 72
export const GLOBE_INTRO_RING_PAIR_INTERVAL_MS = 130
export const GLOBE_INTRO_TILE_FADE_MS = 1600
export const GLOBE_INTRO_CENTER_TILE_FADE_MS = 1450
export const GLOBE_INTRO_EXIT_BLEND_MS = 1100
